...
from dataset import MyDataset, TestDataset, PosEmbTestDataset, MainDataset, PosMainDataset
...
from model.attention_model import ModelTestNodeAggregate, ModelTestNodePosEmbAggregate, MainModel, PosMainModel
